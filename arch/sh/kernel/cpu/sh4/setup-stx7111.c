...
arch_initcall(stx7111_sh4_devices_setup);

static struct platform_device *stx7111_sh4_early_devices[] __initdata = {
	&tmu0_device,
	&tmu1_device,
	&tmu2_device,	
};
...
{
	early_platform_add_devices(stx7111_sh4_early_devices,
				   ARRAY_SIZE(stx7111_sh4_early_devices));
}
