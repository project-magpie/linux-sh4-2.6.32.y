...
INT smartcard_voltage_config(SCI_CONTROL_BLOCK *sci, UINT vcc)
{
    ...
    if (sci->id == 0)
    {
...
#if !defined(CONFIG_SPARK7111) && !defined(HL101) && !defined(ATEVIO7500) && !defined(ADB_BOX) && !defined(VITAMIN_HD5000)  // no votage control
        ...
        else
        {
            ...
            sci->sci_atr_class=SCI_CLASS_A;
#if !defined(SUPPORT_NO_VOLTAGE)
#if !defined(CONFIG_SPARK7111) && !defined(HL101) && !defined(ATEVIO7500) && !defined(ADB_BOX) // no votage control
            set_reg_writeonly(sci, BASE_ADDRESS_PIO4, PIO_SET_P4OUT, 0x40);
#endif
#endif
...
#if defined(CONFIG_CPU_SUBTYPE_STB7100) || defined(CONFIG_CPU_SUBTYPE_STX7100) || defined(CONFIG_SH_ST_MB442) || defined(CONFIG_SH_ST_MB411) || defined(CONFIG_CPU_SUBTYPE_STX7111) || defined(HS7810A) || defined(HS7110) || defined(ATEMIO520) || defined(ATEMIO530) || defined(UFS912) || defined(CONFIG_SPARK7111)
...
#if defined(CONFIG_CPU_SUBTYPE_STX7111) || defined(UFS912) || defined(CONFIG_SPARK7111) || defined(HS7810A) || defined(HS7110) || defined(ATEMIO520) || defined(ATEMIO530) || defined(VITAMIN_HD5000)
